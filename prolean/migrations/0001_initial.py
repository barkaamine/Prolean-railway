    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(choices=[('north', 'Région Nord'), ('central', 'Région Centrale'), ('south', 'Région Sud'), ('coast', 'Région Côtière')], default='central', max_length=20, verbose_name='Région')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('element_text', models.CharField(blank=True, max_length=200, verbose_name="Texte de l'élément")),
                ('element_id', models.CharField(blank=True, max_length=100, verbose_name="ID de l'élément")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('company_name', models.CharField(default='prolean CENTRE', max_length=200, verbose_name='Nom de la société')),
                ...
                ('whatsapp_number', models.CharField(default='+212779259942', max_length=20, verbose_name='Numéro WhatsApp')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flag', models.CharField(default='🏳️', max_length=10, verbose_name='Drapeau')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('training_title', models.CharField(blank=True, max_length=200, verbose_name='Formation concernée')),
                ('session_id', models.CharField(max_length=100, verbose_name='ID de session')),
                ('ip_address', models.GenericIPAddressField(verbose_name='Adresse IP')),
                ('city', models.CharField(blank=True, max_length=100, verbose_name='Ville')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_provider', models.CharField(choices=[('VDOCIPHER', 'VdoCipher'), ('VIMEO', 'Vimeo'), ('YOUTUBE', 'YouTube'), ('OTHER', 'Autre')], default='VDOCIPHER', max_length=50, verbose_name='Fournisseur vidéo')),
                ('video_id', models.CharField(blank=True, max_length=200, null=True, verbose_name='ID Vidéo (auprès du fournisseur)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip_address', models.GenericIPAddressField(verbose_name='Adresse IP')),
                ('user_agent', models.TextField(verbose_name='User Agent')),
                ('city', models.CharField(blank=True, max_length=100, verbose_name='Ville détectée')),
                ('country', models.CharField(blank=True, max_length=100, verbose_name='Pays détecté')),
                ('device_type', models.CharField(blank=True, max_length=50, verbose_name="Type d'appareil")),
            ...
            options={
                ...
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['session_id', 'timestamp'], name='prolean_pag_session_ec06e5_idx'), models.Index(fields=['city', 'timestamp'], name='prolean_pag_city_d9ca72_idx'), models.Index(fields=['url', 'timestamp'], name='prolean_pag_url_10ceac_idx')],
            },
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('STUDENT', 'Étudiant'), ('PROFESSOR', 'Professeur'), ('ASSISTANT', 'Assistant administratif'), ('ADMIN', 'Administrateur')], default='STUDENT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_cities', models.ManyToManyField(blank=True, related_name='assistants', to='prolean.city', verbose_name='Villes assignées')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['ip_address', 'endpoint'], name='prolean_rat_ip_addr_29729f_idx'), models.Index(fields=['is_threat', 'last_request'], name='prolean_rat_is_thre_b27aca_idx')],
            },
        ),
        migrations.CreateModel(
            name='Session',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_date', models.DateField(default=datetime.datetime.now, verbose_name='Date de début')),
                ('end_date', models.DateField(default=datetime.datetime.now, verbose_name='Date de fin')),
                ('status', models.CharField(choices=[('CREATED', 'Créée'), ('ONGOING', 'En cours'), ('COMPLETED', 'Terminée')], default='CREATED', max_length=20, verbose_name='Statut')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount_paid', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=10, verbose_name='Montant payé')),
                ('total_amount_due', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=10, verbose_name='Montant total dû')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detailed_description_ar', models.TextField(blank=True, verbose_name='Description détaillée AR')),
                ...
                ('detailed_description_en', models.TextField(blank=True, verbose_name='Description détaillée EN')),
                ...
                ('programme_structure', models.JSONField(blank=True, default=dict, help_text='Structure JSON du programme théorique et pratique FR', verbose_name='Structure du programme FR')),
                ('programme_theorique', models.TextField(blank=True, default='', verbose_name='Programme théorique FR')),
                ('programme_pratique', models.TextField(blank=True, default='', verbose_name='Programme pratique FR')),
                ('programme_structure_ar', models.JSONField(blank=True, default=dict, help_text='Structure JSON du programme théorique et pratique AR', verbose_name='Structure du programme AR')),
                ('programme_theorique_ar', models.TextField(blank=True, default='', verbose_name='Programme théorique AR')),
                ('programme_pratique_ar', models.TextField(blank=True, default='', verbose_name='Programme pratique AR')),
                ('programme_structure_en', models.JSONField(blank=True, default=dict, help_text='Structure JSON du programme théorique et pratique EN', verbose_name='Structure du programme EN')),
                ('programme_theorique_en', models.TextField(blank=True, default='', verbose_name='Programme théorique EN')),
                ('programme_pratique_en', models.TextField(blank=True, default='', verbose_name='Programme pratique EN')),
                ('success_rate', models.PositiveIntegerField(default=95, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Taux de réussite (%)')),
                ('badge', models.CharField(choices=[('none', 'Aucun badge'), ('popular', '🔥 Populaire'), ('new', '🆕 Nouvelle'), ('promo', '⚡ Promotion')], default='none', max_length=20, verbose_name='Badge')),
                ...
                ('gallery_caption_1', models.CharField(blank=True, max_length=200, verbose_name='Légende image 1 FR')),
                ('gallery_image_2', models.URLField(blank=True, max_length=500, null=True, verbose_name='Image galerie 2')),
                ('gallery_caption_2', models.CharField(blank=True, max_length=200, verbose_name='Légende image 2 FR')),
                ('gallery_image_3', models.URLField(blank=True, max_length=500, null=True, verbose_name='Image galerie 3')),
                ('gallery_caption_3', models.CharField(blank=True, max_length=200, verbose_name='Légende image 3 FR')),
                ('gallery_image_4', models.URLField(blank=True, max_length=500, null=True, verbose_name='Image galerie 4')),
                ('gallery_caption_4', models.CharField(blank=True, max_length=200, verbose_name='Légende image 4 FR')),
                ('gallery_image_5', models.URLField(blank=True, max_length=500, null=True, verbose_name='Image galerie 5')),
                ('gallery_caption_5', models.CharField(blank=True, max_length=200, verbose_name='Légende image 5 FR')),
                ('gallery_caption_1_ar', models.CharField(blank=True, max_length=200, verbose_name='Légende image 1 AR')),
                ('gallery_caption_2_ar', models.CharField(blank=True, max_length=200, verbose_name='Légende image 2 AR')),
                ('gallery_caption_3_ar', models.CharField(blank=True, max_length=200, verbose_name='Légende image 3 AR')),
                ('gallery_caption_4_ar', models.CharField(blank=True, max_length=200, verbose_name='Légende image 4 AR')),
                ('gallery_caption_5_ar', models.CharField(blank=True, max_length=200, verbose_name='Légende image 5 AR')),
                ('gallery_caption_1_en', models.CharField(blank=True, max_length=200, verbose_name='Légende image 1 EN')),
                ('gallery_caption_2_en', models.CharField(blank=True, max_length=200, verbose_name='Légende image 2 EN')),
                ('gallery_caption_3_en', models.CharField(blank=True, max_length=200, verbose_name='Légende image 3 EN')),
                ('gallery_caption_4_en', models.CharField(blank=True, max_length=200, verbose_name='Légende image 4 EN')),
                ('gallery_caption_5_en', models.CharField(blank=True, max_length=200, verbose_name='Légende image 5 EN')),
                ...
                ('stat_exam_success', models.CharField(blank=True, default='98%', max_length=50, verbose_name='Taux de réussite FR')),
                ...
                ('stat_employment_rate_ar', models.CharField(blank=True, default='٪٩٥', max_length=50, verbose_name="Taux d'emploi AR")),
                ('stat_student_satisfaction_ar', models.CharField(blank=True, default='٤٫٨/٥', max_length=50, verbose_name='Satisfaction AR')),
                ('stat_exam_success_ar', models.CharField(blank=True, default='٪٩٨', max_length=50, verbose_name='Taux de réussite AR')),
                ('stat_average_salary_ar', models.CharField(blank=True, default='٨٥٠٠ درهم', max_length=50, verbose_name='Salaire moyen AR')),
                ('stat_company_partnerships_ar', models.CharField(blank=True, default='٥٠+', max_length=50, verbose_name='Entreprises partenaires AR')),
                ...
                ('feature_1', models.CharField(blank=True, max_length=200, verbose_name='Fonctionnalité 1 FR')),
                ('feature_2', models.CharField(blank=True, max_length=200, verbose_name='Fonctionnalité 2 FR')),
                ('feature_3', models.CharField(blank=True, max_length=200, verbose_name='Fonctionnalité 3 FR')),
                ('feature_4', models.CharField(blank=True, max_length=200, verbose_name='Fonctionnalité 4 FR')),
                ('feature_5', models.CharField(blank=True, max_length=200, verbose_name='Fonctionnalité 5 FR')),
                ('feature_1_ar', models.CharField(blank=True, max_length=200, verbose_name='خاصية 1 AR')),
                ('feature_2_ar', models.CharField(blank=True, max_length=200, verbose_name='خاصية 2 AR')),
                ('feature_3_ar', models.CharField(blank=True, max_length=200, verbose_name='خاصية 3 AR')),
                ('feature_4_ar', models.CharField(blank=True, max_length=200, verbose_name='خاصية 4 AR')),
                ('feature_5_ar', models.CharField(blank=True, max_length=200, verbose_name='خاصية 5 AR')),
                ...
                ('prerequisite_1', models.CharField(blank=True, max_length=200, verbose_name='Prérequis 1 FR')),
                ('prerequisite_2', models.CharField(blank=True, max_length=200, verbose_name='Prérequis 2 FR')),
                ('prerequisite_3', models.CharField(blank=True, max_length=200, verbose_name='Prérequis 3 FR')),
                ('prerequisite_4', models.CharField(blank=True, max_length=200, verbose_name='Prérequis 4 FR')),
                ('prerequisite_5', models.CharField(blank=True, max_length=200, verbose_name='Prérequis 5 FR')),
                ('prerequisite_1_ar', models.CharField(blank=True, max_length=200, verbose_name='المتطلبات المسبقة 1 AR')),
                ('prerequisite_2_ar', models.CharField(blank=True, max_length=200, verbose_name='المتطلبات المسبقة 2 AR')),
                ('prerequisite_3_ar', models.CharField(blank=True, max_length=200, verbose_name='المتطلبات المسبقة 3 AR')),
                ('prerequisite_4_ar', models.CharField(blank=True, max_length=200, verbose_name='المتطلبات المسبقة 4 AR')),
                ('prerequisite_5_ar', models.CharField(blank=True, max_length=200, verbose_name='المتطلبات المسبقة 5 AR')),
                ...
                ('faq_question_1_ar', models.CharField(blank=True, max_length=300, verbose_name='سؤال FAQ 1 AR')),
                ('faq_answer_1_ar', models.TextField(blank=True, verbose_name='جواب FAQ 1 AR')),
                ('faq_question_2_ar', models.CharField(blank=True, max_length=300, verbose_name='سؤال FAQ 2 AR')),
                ('faq_answer_2_ar', models.TextField(blank=True, verbose_name='جواب FAQ 2 AR')),
                ('faq_question_3_ar', models.CharField(blank=True, max_length=300, verbose_name='سؤال FAQ 3 AR')),
                ('faq_answer_3_ar', models.TextField(blank=True, verbose_name='جواب FAQ 3 AR')),
                ('faq_question_4_ar', models.CharField(blank=True, max_length=300, verbose_name='سؤال FAQ 4 AR')),
                ('faq_answer_4_ar', models.TextField(blank=True, verbose_name='جواب FAQ 4 AR')),
                ('faq_question_5_ar', models.CharField(blank=True, max_length=300, verbose_name='سؤال FAQ 5 AR')),
                ...
                ('testimonial_name_1', models.CharField(blank=True, max_length=100, verbose_name='Témoin 1 - Nom FR')),
                ('testimonial_review_1', models.TextField(blank=True, verbose_name='Témoin 1 - Témoignage FR')),
                ('testimonial_rating_1', models.PositiveIntegerField(default=5, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='Témoin 1 - Note (1-5)')),
                ('testimonial_position_1', models.CharField(blank=True, max_length=100, verbose_name='Témoin 1 - Poste FR')),
                ('testimonial_name_2', models.CharField(blank=True, max_length=100, verbose_name='Témoin 2 - Nom FR')),
                ('testimonial_review_2', models.TextField(blank=True, verbose_name='Témoin 2 - Témoignage FR')),
                ('testimonial_rating_2', models.PositiveIntegerField(default=5, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='Témoin 2 - Note (1-5)')),
                ('testimonial_position_2', models.CharField(blank=True, max_length=100, verbose_name='Témoin 2 - Poste FR')),
                ('testimonial_name_3', models.CharField(blank=True, max_length=100, verbose_name='Témoin 3 - Nom FR')),
                ('testimonial_review_3', models.TextField(blank=True, verbose_name='Témoin 3 - Témoignage FR')),
                ('testimonial_rating_3', models.PositiveIntegerField(default=5, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='Témoin 3 - Note (1-5)')),
                ('testimonial_position_3', models.CharField(blank=True, max_length=100, verbose_name='Témoin 3 - Poste FR')),
                ('testimonial_name_1_ar', models.CharField(blank=True, max_length=100, verbose_name='شاهد 1 - اسم AR')),
                ('testimonial_review_1_ar', models.TextField(blank=True, verbose_name='شاهد 1 - شهادة AR')),
                ('testimonial_position_1_ar', models.CharField(blank=True, max_length=100, verbose_name='شاهد 1 - منصب AR')),
                ('testimonial_name_2_ar', models.CharField(blank=True, max_length=100, verbose_name='شاهد 2 - اسم AR')),
                ('testimonial_review_2_ar', models.TextField(blank=True, verbose_name='شاهد 2 - شهادة AR')),
                ('testimonial_position_2_ar', models.CharField(blank=True, max_length=100, verbose_name='شاهد 2 - منصب AR')),
                ('testimonial_name_3_ar', models.CharField(blank=True, max_length=100, verbose_name='شاهد 3 - اسم AR')),
                ('testimonial_review_3_ar', models.TextField(blank=True, verbose_name='شاهد 3 - شهادة AR')),
                ('testimonial_position_3_ar', models.CharField(blank=True, max_length=100, verbose_name='شاهد 3 - منصب AR')),
                ...
                ('category_caces', models.BooleanField(db_index=True, default=False, verbose_name='Catégorie CACES Engins')),
                ('category_electricite', models.BooleanField(db_index=True, default=False, verbose_name='Catégorie Électricité')),
                ('category_soudage', models.BooleanField(db_index=True, default=False, verbose_name='Catégorie Soudage')),
                ('category_securite', models.BooleanField(db_index=True, default=False, verbose_name='Catégorie Sécurité')),
                ('category_management', models.BooleanField(db_index=True, default=False, verbose_name='Catégorie Management')),
                ('category_autre', models.BooleanField(db_index=True, default=False, verbose_name='Catégorie Autre')),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['is_active', 'created_at'], name='prolean_tra_is_acti_edfd2a_idx'), models.Index(fields=['is_featured', 'is_active'], name='prolean_tra_is_feat_5a58ff_idx'), models.Index(fields=['category_caces', 'is_active'], name='prolean_tra_categor_78d5ab_idx'), models.Index(fields=['category_electricite', 'is_active'], name='prolean_tra_categor_05cf14_idx'), models.Index(fields=['category_soudage', 'is_active'], name='prolean_tra_categor_30a87a_idx'), models.Index(fields=['price_mad', 'is_active'], name='prolean_tra_price_m_b4495b_idx')],
            },
        ),
        migrations.AddField(
            model_name='studentprofile',
            name='authorized_formations',
            field=models.ManyToManyField(blank=True, related_name='students', to='prolean.training', verbose_name='Formations autorisées'),
        ),
        migrations.AddField(
            model_name='session',
            name='formations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge_text_ar', models.CharField(blank=True, default='عرض', max_length=50, verbose_name='نص الشارة AR')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Date de création')),
                ('training', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prolean.training', verbose_name='Formation associée')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.TextField(verbose_name='Message')),
                ('payment_method', models.CharField(blank=True, choices=[('card', 'Carte bancaire'), ('bank_transfer', 'Virement bancaire'), ('cash', 'Paiement sur place')], max_length=20, verbose_name='Méthode de paiement')),
                ...
                ('transfer_reference', models.CharField(blank=True, max_length=100, verbose_name='Référence virement')),
                ('transfer_date', models.DateField(blank=True, null=True, verbose_name='Date du virement')),
                ('training_title', models.CharField(blank=True, max_length=200, verbose_name='Formation concernée')),
                ('status', models.CharField(choices=[('new', 'Nouveau'), ('contacted', 'Contacté'), ('processing', 'En traitement'), ('completed', 'Traité'), ('archived', 'Archivé')], default='new', max_length=20, verbose_name='Statut')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=20, verbose_name='Téléphone')),
                ('city', models.CharField(max_length=100, verbose_name='Ville')),
                ('payment_method', models.CharField(choices=[('card', 'Carte bancaire'), ('bank_transfer', 'Virement bancaire'), ('cash', 'Paiement sur place')], max_length=50, verbose_name='Méthode de paiement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_session', models.DateField(blank=True, null=True, verbose_name='Session préférée')),
                ('city', models.CharField(max_length=100, verbose_name='Ville')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['status', 'submitted_at'], name='prolean_con_status_2dd1fc_idx'),
        ),
        migrations.AddIndex(
            model_name='contactrequest',
            index=models.Index(fields=['payment_method', 'payment_status'], name='prolean_con_payment_0b5823_idx'),
        ),
        migrations.AddIndex(
            model_name='contactrequest',
            index=models.Index(fields=['lead_score'], name='prolean_con_lead_sc_675907_idx'),
        ),
        migrations.AddIndex(
            model_name='trainingpresubscription',
            index=models.Index(fields=['training', 'payment_status'], name='prolean_tra_trainin_e06740_idx'),
        ),
        migrations.AddIndex(
            model_name='trainingpresubscription',
            index=models.Index(fields=['email', 'created_at'], name='prolean_tra_email_ac02be_idx'),
        ),
        migrations.AddIndex(
            model_name='trainingpresubscription',
            index=models.Index(fields=['transaction_id'], name='prolean_tra_transac_904fa3_idx'),
        ),
        migrations.AddIndex(
            model_name='trainingreview',
            index=models.Index(fields=['training', 'is_approved', 'is_verified'], name='prolean_tra_trainin_677985_idx'),
        ),
        migrations.AddIndex(
            model_name='trainingreview',
            index=models.Index(fields=['rating', 'is_approved'], name='prolean_tra_rating_e6a691_idx'),
        ),
